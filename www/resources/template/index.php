...
<div class="jumbotron">
  <div class="container" style="text-align: center">
    ...
    <p class="lead">TypeSchema is a JSON format to describe data models in a language neutral format. A TypeSchema can
    be easily transformed into specific code for almost any programming language. This helps to reuse core data models
